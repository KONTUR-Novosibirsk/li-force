    ...
    <section class="hit">
        <div class="container">
            <div class="hit__container">
                <div class="hit-swiper_heading">
                    <h2>Может вас заинтересовать</h2>
                    {{--                <div class="hit-swiper_btns">--}}
                    {{--                    <button class="hit-swiper_prev">--}}
                    ...
                    <div class="swiper hit-swiper">
                        <div class="swiper-wrapper">
                            @foreach($products as $product)
                                <div class="swiper-slide hit-item">
